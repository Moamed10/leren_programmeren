...
print(f"het totaal bedrag voor {totaal_personen} personen is  {totaal:.2f} euro ")

print(f"Dit geweldige dagje-uit met {totaal_personen} mensen in speelhal 45 minuten VR kost je maar { totaal:.2f}")
